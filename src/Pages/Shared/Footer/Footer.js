...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-neutral text-base-content flex justify-around">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-neutral text-base-content border-base-300 flex justify-around">
