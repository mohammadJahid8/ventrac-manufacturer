                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            <div>
                                ...
                                <p className='font-semibold mb-3'>Available Quantity: 500</p>
                            ...
                            <label className="mt-8 text-base leading-4 text-gray-800">Order Quantity</label>
                            <div className="mt-2 flex-col">
                                <div>
                                    <input className="border rounded border-gray-300 p-4 w-full text-base leading-4 placeholder-gray-600 text-gray-600" type="number" placeholder="" min="100" max="500" />
                                </div>
                            </div>
