                ...
                <div className="flex flex-col justify-start items-start w-full space-y-9">
                    <div className="flex justify-start flex-col items-start space-y-2">
                        <button
                            ...
                            <svg className="fill-stroke" width="28" height="28" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p
                                className="text-lg leading-none">Back</p>
                        </button>
                    ...
                    <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
                        <div className=" flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 py-7 sm:py-0 xl:py-10 px-10 xl:w-full">
                            <div className="flex flex-col justify-start items-start w-full space-y-4">
                                ...
                                <p className="text-base font-semibold leading-none text-gray-600">${price}.00</p>
                            </div>
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mt-2 flex-col">
                                    <p className='font-semibold mb-3 mt-6'>Available Quantity: {quantity}</p>

                                    <p className='font-semibold mb-3 mt-3'>Per Unit Price: ${price}</p>
                                    ...
                                    <div>
                                        ...
                                        {inputQuantity < minOrder
                                            &&
                                            <p className="text-red-500 text-sm">Minimum order {minOrder}pcs</p>
                                        }
                                        {
                                            inputQuantity > quantity
                                            &&
                                            <p className="text-red-500 text-sm">Maximum order {quantity}pcs</p>
                                        }
                                    </div>
                                </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={(inputQuantity < minOrder || inputQuantity > quantity) && !disabled}
